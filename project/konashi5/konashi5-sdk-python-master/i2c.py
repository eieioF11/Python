...
async def run():
    async with BleakClient(KONASHI_ADDR) as konashi:
        ...
        # await konashi.write_gatt_char(KONASHI_UUID_CONFIG_CMD, bytearray([KONASHI_CFG_CMD_SOFTPWM, 0x01,0xf4,0x01, 0x12,0xf4,0x01, 0x21,0x64,0x00, 0x32,0x64,0x00]))
        # logging.debug("Command: HardPWM config")
        # await konashi.write_gatt_char(KONASHI_UUID_CONFIG_CMD, bytearray([KONASHI_CFG_CMD_HARDPWM, 0x01, 0x11, 0x21, 0x31, 0xFF,0x00,0x00,0x96]))
        ...
        await konashi.write_gatt_char(KONASHI_UUID_CONFIG_CMD, bytearray([KONASHI_CFG_CMD_I2C, 0x02]))
        ...
        # await konashi.write_gatt_char(KONASHI_UUID_CONTROL_CMD, bytearray([KONASHI_CTL_CMD_SOFTPWM, 0x00,0xf4,0x01,0x00,0x00, 0x01,0xf4,0x01,0x00,0x00, 0x02,0xf4,0x01,0x00,0x00, 0x03,0xf4,0x01,0x00,0x00]))
        # logging.debug("Command: HardPWM control")
        # await konashi.write_gatt_char(KONASHI_UUID_CONTROL_CMD, bytearray([KONASHI_CTL_CMD_HARDPWM, 0x00,0x00,0x0f,0x00,0x00, 0x01,0x80,0x25,0x00,0x00, 0x02,0x00,0x4b,0x00,0x00, 0x03,0x00,0x96,0x00,0x00]))
        ...
        while await konashi.is_connected():
            ...
            logging.debug("Command: I2C control")
            # await konashi.write_gatt_char(KONASHI_UUID_CONTROL_CMD, bytearray([KONASHI_CTL_CMD_I2C_DATA, 0x00, 0x00, 0x04, 0x48,0x65,0x6c,0x6c,0x6f,0x20,0x57,0x6f,0x72,0x6c,0x64,0x20,0x28,0x53,0x65,0x62,0x29]))
            # await konashi.write_gatt_char(KONASHI_UUID_CONTROL_CMD, bytearray([KONASHI_CTL_CMD_I2C_DATA, 0x01, 0x06, 0x02]))
            await konashi.write_gatt_char(KONASHI_UUID_CONTROL_CMD, bytearray([KONASHI_CTL_CMD_I2C_DATA, 0x02, 0x08, 0x29, 0x00,0x00]))
