...
if __name__ == "__main__":
    async def main():
        ...
        #k3.gpioSetInputCallback(pin_change_cb)
        #await k3.gpioConfigSet([(0x01,True,KonashiGpioPinConfig(KONASHI_GPIO_DIRECTION_IN,send_on_change=True)), (0x1E,True,KonashiGpioPinConfig(KONASHI_GPIO_DIRECTION_OUT,send_on_change=False))])
        #await k3.builtinSetPresenceCallback(presence_cb2)
        #await asyncio.sleep(1)
        ...
        while(True):
            ...
            if Presence and button==False:
                if Home:
                    ...
                    await k2.builtinSetRgb(R,G,B, 255, 500)
                    #await k3.builtinSetRgb(R,G,B, 255, 200)
                else:
                    if SendFlag ==False:
                        bot.send(
                            message="\n[Warning!]\n家に誰かいる!!\n",
                ...
                if Alert==False:
                    ...
                    #await k3.builtinSetRgb(0,0,0, 255, 200)
                SendFlag=False
        ...
        #await k3.gpioControl([(0x1E,KONASHI_GPIO_LEVEL_LOW)])
        await k.gpioControl([(0x1E,KONASHI_GPIO_LEVEL_HIGH)])
        await k2.gpioControl([(0x1E,KONASHI_GPIO_LEVEL_HIGH)])
        #await k3.gpioControl([(0x1E,KONASHI_GPIO_LEVEL_HIGH)])
        ...
        #await k3.builtinSetRgb(0,0,0, 255, 1000)
        await k.disconnect()
        await k2.disconnect()
        #await k3.disconnect()
