...
async def run():
    async with BleakClient(KONASHI_ADDR) as konashi:
        ...
        await konashi.write_gatt_char(KONASHI_UUID_CONFIG_CMD, bytearray([KONASHI_CFG_CMD_ANALOG, 0x09, 0x19, 0x29, 0xD4, 0xC3]))
        ...
        await konashi.write_gatt_char(KONASHI_UUID_CONTROL_CMD, bytearray([KONASHI_CTL_CMD_ANALOG, 0x00,0x1F,0x00,0x00,0x00, 0x01,0x55,0x05,0x00,0x00, 0x02,0xAA,0x0A,0x00,0x00]))
